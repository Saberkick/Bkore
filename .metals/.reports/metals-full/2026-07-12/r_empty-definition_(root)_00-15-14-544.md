error id: file://<WORKSPACE>/src/main/scala/mycpu/Top.scala:inst_cache
file://<WORKSPACE>/src/main/scala/mycpu/Top.scala
empty definition using pc, found symbol in pc: inst_cache
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/bridge/io/inst_cache.
	 -chisel3/bridge/io/inst_cache#
	 -chisel3/bridge/io/inst_cache().
	 -chisel3/util/bridge/io/inst_cache.
	 -chisel3/util/bridge/io/inst_cache#
	 -chisel3/util/bridge/io/inst_cache().
	 -bridge/io/inst_cache.
	 -bridge/io/inst_cache#
	 -bridge/io/inst_cache().
	 -scala/Predef.bridge.io.inst_cache.
	 -scala/Predef.bridge.io.inst_cache#
	 -scala/Predef.bridge.io.inst_cache().
offset: 10026
