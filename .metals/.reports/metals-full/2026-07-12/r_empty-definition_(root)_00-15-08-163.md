error id: file://<WORKSPACE>/src/main/scala/mycpu/Top.scala:current_valid
file://<WORKSPACE>/src/main/scala/mycpu/Top.scala
empty definition using pc, found symbol in pc: current_valid
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/mem_stage/io/current_valid.
	 -chisel3/mem_stage/io/current_valid#
	 -chisel3/mem_stage/io/current_valid().
	 -chisel3/util/mem_stage/io/current_valid.
	 -chisel3/util/mem_stage/io/current_valid#
	 -chisel3/util/mem_stage/io/current_valid().
	 -mem_stage/io/current_valid.
	 -mem_stage/io/current_valid#
	 -mem_stage/io/current_valid().
	 -scala/Predef.mem_stage.io.current_valid.
	 -scala/Predef.mem_stage.io.current_valid#
	 -scala/Predef.mem_stage.io.current_valid().
offset: 8543
...
class mycpu_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
        ...
        val mem_is_cacop = mem_stage.io.curren@@t_valid && mem_stage.io.out.bits.is_cacop
        ...
        icache.io.cpu.cacop_en := ex_is_icache_cacop && ex_stage.io.data_sram.req
        ...
        if_stage.io.inst_sram.data_ok := icache.io.cpu.data_ok && !ex_is_icache_cacop && !mem_is_icache_cacop
        ...
        dcache.io.cpu.cacop_en := ex_is_dcache_cacop && ex_stage.io.data_sram.req
