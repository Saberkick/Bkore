error id: file://<WORKSPACE>/src/main/scala/mycpu/StageWB.scala:ertnFlush
file://<WORKSPACE>/src/main/scala/mycpu/StageWB.scala
empty definition using pc, found symbol in pc: ertnFlush
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/csr/io/ertnFlush.
	 -chisel3/csr/io/ertnFlush#
	 -chisel3/csr/io/ertnFlush().
	 -chisel3/util/csr/io/ertnFlush.
	 -chisel3/util/csr/io/ertnFlush#
	 -chisel3/util/csr/io/ertnFlush().
	 -csr/io/ertnFlush.
	 -csr/io/ertnFlush#
	 -csr/io/ertnFlush().
	 -scala/Predef.csr.io.ertnFlush.
	 -scala/Predef.csr.io.ertnFlush#
	 -scala/Predef.csr.io.ertnFlush().
offset: 2430
...
class StageWB extends Module {
    ...
    val is_fetch_exc = (data_reg.ecode === "h08".U) || 
                       (data_reg.ecode === "h03".U) || 
                       (data_reg.inst === "h03400000".U(32.W))

    csr.io.excAddr     := Mux(is_fetch_exc, data_reg.pc, data_reg.ex_result)
    
    csr.io.e@@rtnFlush   := valid_reg && data_reg.inst_ertn
    ...
    io.tlb_w_idx := Mux(is_tlbfill, rand_idx, csr.io.tlbidx_out)
