error id: file://<WORKSPACE>/src/main/scala/mycpu/Top.scala:rf_raddr1
file://<WORKSPACE>/src/main/scala/mycpu/Top.scala
empty definition using pc, found symbol in pc: rf_raddr1
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/id_stage/io/rf_raddr1.
	 -chisel3/id_stage/io/rf_raddr1#
	 -chisel3/id_stage/io/rf_raddr1().
	 -chisel3/util/id_stage/io/rf_raddr1.
	 -chisel3/util/id_stage/io/rf_raddr1#
	 -chisel3/util/id_stage/io/rf_raddr1().
	 -id_stage/io/rf_raddr1.
	 -id_stage/io/rf_raddr1#
	 -id_stage/io/rf_raddr1().
	 -scala/Predef.id_stage.io.rf_raddr1.
	 -scala/Predef.id_stage.io.rf_raddr1#
	 -scala/Predef.id_stage.io.rf_raddr1().
offset: 2992
...
class mycpu_top extends RawModule {
    ...
    withClockAndReset(clk, reset_high) {
        ...
        // 7. 寄存器堆 (RegFile) 连线
        regfile.io.raddr1 := id_stage.io.r@@f_raddr1
