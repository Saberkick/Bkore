error id: file://<WORKSPACE>/src/main/scala/mycpu/Top.scala:branch_req
file://<WORKSPACE>/src/main/scala/mycpu/Top.scala
empty definition using pc, found symbol in pc: branch_req
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/ex_stage/io/branch_req.
	 -chisel3/ex_stage/io/branch_req#
	 -chisel3/ex_stage/io/branch_req().
	 -chisel3/util/ex_stage/io/branch_req.
	 -chisel3/util/ex_stage/io/branch_req#
	 -chisel3/util/ex_stage/io/branch_req().
	 -ex_stage/io/branch_req.
	 -ex_stage/io/branch_req#
	 -ex_stage/io/branch_req().
	 -scala/Predef.ex_stage.io.branch_req.
	 -scala/Predef.ex_stage.io.branch_req#
	 -scala/Predef.ex_stage.io.branch_req().
offset: 2058
...
class mycpu_top extends RawModule {
    ...
    withClockAndReset(clk, reset_high) {
        ...
        // 3. Ctrl 中枢路由
        ctrl.io.ex_branch_req := ex_stage.io.branch_re@@q
