error id: file://<WORKSPACE>/src/main/scala/mycpu/StageEX.scala:
file://<WORKSPACE>/src/main/scala/mycpu/StageEX.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/io/data_sram/wstrb.
	 -chisel3/io/data_sram/wstrb#
	 -chisel3/io/data_sram/wstrb().
	 -chisel3/util/io/data_sram/wstrb.
	 -chisel3/util/io/data_sram/wstrb#
	 -chisel3/util/io/data_sram/wstrb().
	 -io/data_sram/wstrb.
	 -io/data_sram/wstrb#
	 -io/data_sram/wstrb().
	 -scala/Predef.io.data_sram.wstrb.
	 -scala/Predef.io.data_sram.wstrb#
	 -scala/Predef.io.data_sram.wstrb().
offset: 7437
...
class StageEX extends Module {
    ...
    //MODDED in AXI experiment
    ready_go := mdu_ready && (!is_mem || req_fire || mem_req_sent)
