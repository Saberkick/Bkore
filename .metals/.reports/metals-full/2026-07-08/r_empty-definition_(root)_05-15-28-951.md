error id: file://<WORKSPACE>/src/main/scala/mycpu/StageEX.scala:mycpu/StageEX#stMaskB.
file://<WORKSPACE>/src/main/scala/mycpu/StageEX.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol mycpu/StageEX#stMaskB.
...
class StageEX extends Module {
    ...
    val 
    //R/W DataMEM
    val stMas@@kB = "b0001".U(4.W) << alu_res(1, 0)
