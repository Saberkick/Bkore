error id: file://<WORKSPACE>/src/main/scala/mycpu/Top.scala:wb_flush
file://<WORKSPACE>/src/main/scala/mycpu/Top.scala
empty definition using pc, found symbol in pc: wb_flush
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/wb_stage/io/wb_flush.
	 -chisel3/wb_stage/io/wb_flush#
	 -chisel3/wb_stage/io/wb_flush().
	 -chisel3/util/wb_stage/io/wb_flush.
	 -chisel3/util/wb_stage/io/wb_flush#
	 -chisel3/util/wb_stage/io/wb_flush().
	 -wb_stage/io/wb_flush.
	 -wb_stage/io/wb_flush#
	 -wb_stage/io/wb_flush().
	 -scala/Predef.wb_stage.io.wb_flush.
	 -scala/Predef.wb_stage.io.wb_flush#
	 -scala/Predef.wb_stage.io.wb_flush().
offset: 2141
...
class mycpu_top extends RawModule {
    ...
    withClockAndReset(clk, reset_high) {
        ...
        ctrl.io.wb_flush      := wb_stage.io.wb_fl@@ush
