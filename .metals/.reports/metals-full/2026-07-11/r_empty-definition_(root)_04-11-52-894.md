error id: file://<WORKSPACE>/src/main/scala/mycpu/Cache.scala:mycpu/Cache#req_op.
file://<WORKSPACE>/src/main/scala/mycpu/Cache.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol mycpu/Cache#req_op.
...
class Cache extends Module {
    ...
    //Req Buffer Latch
    val is_lookup_write = (main_state === sLookup) && (r@@eq_op === true.B)
    //If new addr (Both Idx and Offset) (is the same as current write addr
