error id: file://<WORKSPACE>/src/main/scala/mycpu/Cache.scala:mycpu/Cache#hazard_with_lookup.
file://<WORKSPACE>/src/main/scala/mycpu/Cache.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol mycpu/Cache#hazard_with_lookup.
...
class Cache extends Module {
    ...
    switch(wb_state) {
        is(wbIdle) {
            ...
            when(is_lookup_write_hit && cache_hit) { 
                wb_state := wbWrite
