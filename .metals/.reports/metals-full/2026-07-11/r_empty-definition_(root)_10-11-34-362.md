error id: file://<WORKSPACE>/src/main/scala/mycpu/Top.scala:data_sram
file://<WORKSPACE>/src/main/scala/mycpu/Top.scala
empty definition using pc, found symbol in pc: data_sram
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/bridge/io/data_sram.
	 -chisel3/util/bridge/io/data_sram.
	 -bridge/io/data_sram.
	 -scala/Predef.bridge.io.data_sram.
offset: 9641
...
class mycpu_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
        ...
        mem_stage.io.sram_data_ok     := bridge.io.data@@_sram.data_ok
