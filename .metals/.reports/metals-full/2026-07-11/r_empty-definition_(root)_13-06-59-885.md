error id: file://<WORKSPACE>/src/main/scala/mycpu/Top.scala:data_uncached
file://<WORKSPACE>/src/main/scala/mycpu/Top.scala
empty definition using pc, found symbol in pc: data_uncached
...
class mycpu_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
        ...
        // ==========================================
        // ★ CACOP 路由解码 (从 EX 级截获)
        val ex_is_cacop = ex_stage.io.out.bits.is_cacop
        ...
        icache.io.cpu.uncached := Mux(is_icache_cacop, ex_stage.io.data_uncache@@d, if_stage.io.inst_uncached)
