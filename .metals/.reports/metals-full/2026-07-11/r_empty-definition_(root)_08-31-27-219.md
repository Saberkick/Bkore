error id: file://<WORKSPACE>/src/main/scala/mycpu/Top.scala:local0
file://<WORKSPACE>/src/main/scala/mycpu/Top.scala
empty definition using pc, found symbol in pc: local0
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/icache/io/cpu.
	 -chisel3/util/icache/io/cpu.
	 -icache/io/cpu.
	 -scala/Predef.icache.io.cpu.
offset: 8118
...
class mycpu_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
        ...
        icache.io.cp@@u.op     := false.B // ICache 恒为读 (0)
